...
# Disable research tools for Streamlit Cloud compatibility
...
def initialize_agents(llm):
    ...
    # Simple setup without external tools (Streamlit Cloud compatible)
    research_tools = []
    print("🔍 Research agent configured (no external tools for Streamlit Cloud compatibility)")
